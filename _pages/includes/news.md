...
<ul style="width: auto; height: 180px; overflow: auto; background-color: #F7F7F7">
	...
	<li>[2022.09]: One journal paper is accepted by <i>Cell Research </i> (IF:46.3) with the available <a href="https://github.com/jianqingzheng/XBCR-net"><img src="https://img.shields.io/github/stars/jianqingzheng/XBCR-net?style=social&label=Code+Stars+<i class="fa-regular fa-star fa-beat-fade"></i>" /></a>.
	</li>
