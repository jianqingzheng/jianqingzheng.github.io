...
<div class="bottom_box" >
	<ul class="events">
		...
		<code><i class="fas fa-heartbeat white-icon"></i> Surg_Navig</code> One journal papers accepted by <abbr title="impact factor: 18.1 (Q1)"><i>Nature Communications</i></abbr>.
		</li>
...
        </li>
		...
		Honored to join the <b>Editorial Board</b> of <abbr title="impact factor: 4.1 (Q1)"><i>MedScience</i></abbr>, Springer Nature.
        </li>
		<li data-date="2025/06">: 
		Honored to be recognized as an <b>Outstanding Reviewer</b> at <abbr title="IEEE/CVF Conference on Computer Vision and Pattern Recognition"><i>IEEE/CVF CVPR 2025</i></abbr>.
		</li>
